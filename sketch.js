...
//mam my bird and score is not displayed
//also the game is back to serve state as soon as i release the enter
//also,my text is not displayed 
var SERVE=2;
var PLAY=1;
var END=0;
var gameState=PLAY;
...
function preload(){
    ...
    bird1=loadAnimation("bird-1.png","bird-2.png","bird-1.png","bird-2.png"); 
    bird2=loadAnimation("bird-2-1.png","bird-2-2.png","bird-2-1.png","bird-2-2.png");
...
if(gameState=SERVE){
 ...
 text("use up arrow to jump  and space key to use weapon",200,250);
...
if(frameCount % 200===0){
  ...
  switch(rand){
   ...
   case 1:bird.addAnimation("bird-1.png","bird-2.png");
   break;
   case 2:bird.addAnimation("bird-2-1.png","bird-2-2.png");
   break;
   default:break;
     }
     bird.scale=0.05;
